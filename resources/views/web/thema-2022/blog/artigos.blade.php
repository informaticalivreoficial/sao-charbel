                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="bsingle__post mb-50">
                                    ...
                                    <div class="date-home">
                                        ...
                                        <h2><a href="{{route(($post->tipo == 'noticia' ? 'web.noticia' : 'web.blog.artigo'), [ 'slug' => $post->slug ])}}">{{$post->titulo}}</a></h2>
                                        {!!\App\Helpers\Renato::Words($post->content, 25)!!}
                                        <div class="blog__btn">
                                            <a href="{{route(($post->tipo == 'noticia' ? 'web.noticia' : 'web.blog.artigo'), [ 'slug' => $post->slug ])}}">Ler +</a>
                                        </div>
                                    </div>
                                </div>

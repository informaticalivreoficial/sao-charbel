                                    ...
                                    <div class="col-12 col-md-12 col-lg-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input id="exibir_assinante" class="form-check-input" type="radio" value="1" name="assinante" {{(old('assinante') == '1' ? 'checked' : '')}}>
                                                <label for="exibir_assinante" class="form-check-label mr-5">Sim</label>
                                                <input id="exibir_assinantenao" class="form-check-input" type="radio" value="0" name="assinante" {{(old('assinante') == '0' ? 'checked' : '')}}>
